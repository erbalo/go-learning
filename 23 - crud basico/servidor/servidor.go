...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro = json.Unmarshal(corpoRequisicao, &usuario); erro != nil {
		w.Write([]byte("Error ao converter o usuario para struct"))
		return
	}
	...
	w.Write([]byte(fmt.Sprintf("Usuario inserido como sucesso! Id: %d", idInserido)))
}

// BuscarUsuarios traz todos os usuarios salvos ao bando de dados
func BuscarUsuarios(w http.ResponseWriter, r *http.Request) {
	...
	for linhas.Next() {
		...
		// orden es importante de la tabla
...
// BuscarUsuario traz um usuario especifico salvo ao bando de dados
